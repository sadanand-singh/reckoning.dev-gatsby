...
limited help. After I got [my new desktop](/blog/my-desktop), my goal was to setup it with a _modern_
...
https://youtube.com/watch?v=MMkST5IjSjY
...
```bash:title=/etc/hosts|showLines=false
vim /etc/hosts
...
...
```bash:title=/etc/systemd/network/wired.network|showLines=false
$
...
[Match]
Name=enp4s0

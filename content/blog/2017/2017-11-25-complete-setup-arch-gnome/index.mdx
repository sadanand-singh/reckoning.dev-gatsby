...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center">System Info</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/ApplicationMenu.png"/>
    <figcaption class="text-center">Application Menu</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center">Gnome Workspaces</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/Apps.png"/>
    <figcaption class="text-center">Gnome Applications</figcaption>
    </figure>
  </div>
</div>
...
```shell:title=/etc/fstab|showLines=false
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center">Editors</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988350/images/gnome3/pcloud.png"/>
    <figcaption class="text-center">pCloud App</figcaption>
    </figure>
  </div>
</div>

...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-sm">System Info</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/ApplicationMenu.png"/>
    <figcaption class="text-center text-sm">Application Menu</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Gnome Workspaces</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/Apps.png"/>
    <figcaption class="text-center text-xs">Gnome Applications</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-sm">Editors</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988350/images/gnome3/pcloud.png"/>
    <figcaption class="text-center text-sm">pCloud App</figcaption>
    </figure>
  </div>
</div>

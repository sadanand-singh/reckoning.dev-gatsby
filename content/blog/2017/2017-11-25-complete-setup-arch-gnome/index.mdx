...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/SystemInfo.png"/>
    <figcaption className="text-center text-sm">System Info</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/ApplicationMenu.png"/>
    <figcaption className="text-center text-sm">Application Menu</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988350/images/gnome3/workspaces.png"/>
    <figcaption className="text-center text-xs">Gnome Workspaces</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988349/images/gnome3/Apps.png"/>
    <figcaption className="text-center text-xs">Gnome Applications</figcaption>
    </figure>
  </div>
</div>
...
```bash:title=/etc/fstab|showLines=false
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988348/images/gnome3/editors.png"/>
    <figcaption className="text-center text-sm">Editors</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1544988350/images/gnome3/pcloud.png"/>
    <figcaption className="text-center text-sm">pCloud App</figcaption>
    </figure>
  </div>
</div>
...
```bash:title=/etc/pacman.d/hooks/nvidia.hook
[Trigger]
Operation=Install
Operation=Upgrade
Operation=Remove

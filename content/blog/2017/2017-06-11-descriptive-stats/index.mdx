...
$$
\sigma = \sqrt{\frac{1}{n}\Big[\big(a_1 - A\big)^2 + \ldots + \big(a_n - A\big)^2\Big]},
$$

Where $A$ is the Mean. A higher standard deviation value indicates greater spread in the data. A good rule of thumb for a

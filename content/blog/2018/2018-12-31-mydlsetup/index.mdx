...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Gnome Activities</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230615/gnome/chrome_jx6pit.png"/>
    <figcaption class="text-center text-xs">Google Chrome</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Applications Search</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230613/gnome/terminal_g3jr6j.png"/>
    <figcaption class="text-center text-xs">Terminal</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Gnome Tweaks</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230615/gnome/vscode_fcsbl4.png"/>
    <figcaption class="text-center text-xs">Visual Studio Code</figcaption>
    </figure>
  </div>
</div>

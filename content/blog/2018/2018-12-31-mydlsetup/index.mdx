...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230616/gnome/activities_fsd0wm.png"/>
    <figcaption className="text-center text-xs">Gnome Activities</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230615/gnome/chrome_jx6pit.png"/>
    <figcaption className="text-center text-xs">Google Chrome</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230615/gnome/searchApps_y1tgmu.png"/>
    <figcaption className="text-center text-xs">Applications Search</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230613/gnome/terminal_g3jr6j.png"/>
    <figcaption className="text-center text-xs">Terminal</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230614/gnome/gnomeTweaks_p0fkkv.png"/>
    <figcaption className="text-center text-xs">Gnome Tweaks</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1546230615/gnome/vscode_fcsbl4.png"/>
    <figcaption className="text-center text-xs">Visual Studio Code</figcaption>
    </figure>
  </div>
</div>

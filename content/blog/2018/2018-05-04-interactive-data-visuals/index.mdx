...
**NOTE: Please note that the interactive plots here do not load, as it requires loading a really
large data and javascript file!**
...
```html:showLines=false
<div className="bk-root" id="9574d123-9332-4b5f-96cc-6323bef37f40"></div>
```
...
<div className="figure img-responsive" style="display:table; margin:0 auto;">
  <div className="bk-root">
    <div className="bk-plotdiv" id="70a9bff7-7337-40c4-8cdc-df05cca05bbc"></div>
  </div>
</div>
<br />
...
<div className="figure img-responsive" style="display:table; margin:0 auto;">
  <div className="bk-root">
    <div className="bk-plotdiv" id="4eb7ee0d-9bbd-4913-8fe3-cdf4ac8d3b76"></div>
  </div>
</div>
...
<div className="figure img-responsive" style="display:table; margin:0 auto;">
  <div className="bk-root">
    <div className="bk-plotdiv" id="263adf9e-e4ca-4956-b639-625cb60db723"></div>
  </div>
</div>
...
<div className="figure img-responsive" style="display:table; margin:0 auto;">
  <div className="bk-root">
    <div className="bk-plotdiv" id="25335196-889d-4a91-abf1-50eab0a82026"></div>
  </div>
</div>
...
<div className="figure img-responsive" style="display:table; margin:0 auto;">
  <div className="bk-root">
    <div className="bk-plotdiv" id="f1d5b738-1f83-49b0-89e6-81cde11f75fd"></div>
  </div>
</div>

...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Small Amount of Linearity</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1596305002/linearregression02_x5dcb8.jpg"/>
    <figcaption class="text-center text-xs">No Linearity</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">QQ Plot for Normal Dist Data</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1545762768/1920px-Normal_exponential_qq.svg_nrgiqh.png"/>
    <figcaption class="text-center text-xs">QQ Plot for Exponential Dist Data</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">None-homoscedastic data example 1</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1596304559/linearregression07_mpiycr.jpg"/>
    <figcaption class="text-center text-xs">None-homoscedastic data example 2</figcaption>
    </figure>
  </div>
</div>
...
<figure>
  ...
  <figcaption class="text-center text-sm">Polynomial Regression Example</figcaption>
</figure>
...
<figure>
  ...
  <figcaption class="text-center text-sm">Signal Smoothing Example</figcaption>
</figure>

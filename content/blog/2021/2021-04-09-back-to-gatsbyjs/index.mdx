...
React allows me to code this right in the markdown files and visualize it without rebuilding by
site again and again. You can look at my React component that enables rendering the above plot here

...
But, I am an now fully convinced to stick with gatsby. Keep reading if you want to know what made
...
[Code::Stats](https://codestats.net/users/sadanand-singh) to track my coding habit. Their online
page provides a good summary of my data, but I was also interesting in additional things like

- How am I doing on different days of the Week?
- What fraction of my time is spent on different languages that I work with?

<!-- inset codestats plot here -->

React allows me to code this right and visualize this without rebuilding by site again and again.
You can look at my React component that enables rendering the above plot here at
[Github](https://github.com/sadanand-singh/reckoning.dev-gatsby/blob/main/src/components/codeStats.js).


## (Re)Active/Interactive Components Everywhere!

You just saw above, now I can add dynamic plots in the middle of this markdown. Similarly, we can
add any type of react components in markdown and build really powerful sites! You can take a look
all of my components at this site's
[Github Repo](https://github.com/sadanand-singh/reckoning.dev-gatsby/blob/main/src/components/).

Any of these components can be easily added to mdx files as follows:
...
understand a lot more about many of the underlying technologies, it was a lot of fun rewriting
different parts.

...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    ...
    <figcaption className="text-center text-xs">Status of All Experiments</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1555804423/comet/exp_charts_qywcey.png"/>
    <figcaption className="text-center text-xs">Progress of Individual Experiments</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    ...
    <figcaption className="text-center text-xs">GPU Utilization</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1555805270/comet/reproduce_exp_x0zeaf.png"/>
    <figcaption className="text-center text-xs">Experiment Reproducibility</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    ...
    <figcaption className="text-center text-xs">Tracking Individual Metrics</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1557038994/comet/dirty_compare_qo6i7x.png"/>
    <figcaption className="text-center text-xs">Comparing Experiments</figcaption>
    </figure>
  </div>
</div>
...
<div className="flex flex-col md:flex-row">
  <div className="flex-1 p-1 m-1">
    ...
    <figcaption className="text-center text-xs">Diff across different experiments</figcaption>
    </figure>
  </div>
  <div className="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1557084082/comet/clean_compare.png"/>
    <figcaption className="text-center text-xs">Comparing Multiple Experiment Metrics</figcaption>
    </figure>
  </div>
</div>

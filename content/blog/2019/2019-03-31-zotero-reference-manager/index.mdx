...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">Zotero Syncing</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1554089529/zotero_d3qwsp.png"/>
    <figcaption class="text-center text-xs">Zotero References Layouts</figcaption>
    </figure>
  </div>
</div>
...
<div class="flex flex-col md:flex-row">
  <div class="flex-1 p-1 m-1">
    ...
    <figcaption class="text-center text-xs">zotfile Renaming Preferences</figcaption>
    </figure>
  </div>
  <div class="flex-1 p-1 m-1">
    <figure>
    <img src="https://res.cloudinary.com/sadanandsingh/image/upload/v1579590803/zotfile_tablet_settigs_gxcxrx.png"/>
    <figcaption class="text-center text-xs">zotfile Tablet Preferences</figcaption>
    </figure>
  </div>
</div>
...
<figure>
  ...
  <figcaption class="text-center text-xs">Quicklook Preview on Pressing Space</figcaption>
</figure>
